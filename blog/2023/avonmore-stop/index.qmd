...
description: "As the Urban Planning Committee discusses an interim district planning report, here's a closer look at what's in store for the area around Avonmore Stop on the Valley Line."
draft: true
---
...
```{r}
area_prop_raw <- as.numeric(st_area(st_union(avonmore_nodes_corridors)) / st_area(belmac_station_area))
```

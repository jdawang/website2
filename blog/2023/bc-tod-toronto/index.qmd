...
It has layers for zoning, height (in approximate storeys) and each of the radii from BC's new policy. You can also toggle between a couple regular basemap and a a satellite image basemap. Data is not easily available for secondary plans so that is one gap of the map. Hope you enjoy and find it useful!
...
mv <- mapView(
  ...
  map.types=c("CartoDB.Positron", "Esri.WorldGrayCanvas", "Esri.WorldImagery")
) +
  mapview(

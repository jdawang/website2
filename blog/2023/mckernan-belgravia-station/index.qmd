...
The fight for better zoning was [fought and won](https://edmonton.citynews.ca/2023/10/24/edmonton-new-zoning-bylaw/) at Edmonton City Council about a month ago -- and it wasn't even close. Council voted 11-2 in favour of adopting the new zoning without immediate amendments. At a minimum, infill will be allowed on every lot up to 8 units and 10.5m. As well, the vast majority of future study motions with the goal of watering down the new zoning by-law were voted down.

Onwards to [district planning](https://www.edmonton.ca/city_government/urban_planning_and_design/district-planning) which is in it's final stage of consultation. District planning will define the borders of "nodes and corridors" where site-specific rezonings for higher density are likely to be supported. While I generally disagree with this approach that concentrates higher density along higher-trafficked roads, that is the scope and compromise of the initiative.
...
As an example, let's take a closer look at the least used station on the entire Edmonton LRT network, McKernan/Belgravia, built recently in 2009. But first, a primer on corridors in district planning. If you're already familiar with district planning, skip straight to @sec-growth-or-not for a look at population and housing growth over the past 20 years using census data. Lastly, @sec-no-tod-planned-here maps out what district planning actually means around McKernan/Belgravia station and compares it to the new BC legislation.
...
Secondary corridors will support low-rise (up to 4 storeys) throughout and mid-rise along the main streets. Transition to lower density will be supported along the edges of the secondary corridor. There are no provisions for additional density near rapid transit stations.
...
Since we have data on a DB level, we can also look at population and dwelling growth spatially in @fig-cum-change-belmac-absolute and @fig-cum-change-belmac-percent. Dwelling and population growth has mostly occurred on the east side of 114 St and the LRT line in McKernan and two DBs in Belgravia on either side of 76 Ave where low-rise apartments were redeveloped into higher density low-rise apartments, as can be seen on [streetview](https://maps.app.goo.gl/jRp3fd9zHKB7C85r6).
...
Once again, we can break down the census-over-census change by DB, as shown in @fig-belmac-census-over-census-change-absolute and @fig-belmac-census-over-census-change-percent. We can see the driver of the increase in dwellings in 2011-2016 being the demolition (seen in 2005-2011) and subsequent replacement of the aforementioned low-rise apartments on 76 Ave west of the station. We can also see the second demolition and replacement of low-rise apartments happen across the street in 2016-2021. More recently, we can see the demolition of mostly single-family homes north of the station along University Ave with under construction (at the time) mid-rise apartments that should increase dwellings and population in those blocks in the upcoming census. Most other blocks have largely had very gentle intensification or largely remained static.
...
## More transit-oriented development needed from district plan {#sec-no-tod-planned-here}
...
I've stitched all of this together in an animation below in @fig-nodes-corridors-animated, if you want to see the progression as we remove more and more sites that won't really see much higher density than today under the nodes and corridors of district planning. Remember that BC's new legislation applied to McKernan/Belgravia Station would support 8 storeys over 100% of the station area (minus parks, fire halls, etc) and even taller buildings within the 400m and 200m radii.
...
The Scona district plan is certainly an improvement on the area redevelopment plan, allowing higher densities along the main streets of 76 Ave and 114 St. However, we need to fully leverage every one of the few rapid transit stations in Edmonton to avoid a spreading Canadian housing crisis, dial back sprawl and achieve the city's target of 50% infill development. BC's government has set a new bar in Canada for transit-oriented development and that's where we should start. There is no good reason why a random point between the four-lane stroads of Calgary Trail and Gateway should be designated for high density, but a site that's a five minute walk from McKernan/Belgravia Station should only be designated for low density.

![Scona district map, cropped](mckernan_belgravia_station_district_map.png){#fig-scona-district-map}

Higher density permissions around major transit stations should be written into the district plans. It shouldn't matter whether rapid transit stations are within a primary corridor, secondary corridor, major node or none of them. This can happen either before the final draft district policy and plans are brought back to council in 2024 or in subsequent amendments by council. If you agree with me, please a few minutes to tell City Planning this in their [district policy survey](https://cityofedmonton.qualtrics.com/jfe/form/SV_cOtuG43o6YNnAea?EE).

...
assessment_2024 <- historical %>% filter(assessment_year == 2024)
...
redeveloped_accounts <- assessment_2024$account_number[
...
#| label: merge-data
#| cache: true
years_included <- 2015:2024
merged_fn <- here(
  "data",
  glue::glue("merged_v2_{min(years_included)}_{max(years_included)}.rds")
)

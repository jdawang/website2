...
```{r}
#| label: tbl-probs
#| tbl-cap: "Less than 0.5% of properties redeveloped in the RS Zone creates a couple thousand homes in 2025"
...
Despite this record-breaking success, our progress is fragile. In February, City Council will probably once again consider a proposal to reduce the hard cap on homes per lot from eight down to six, along with multiple other reductions.

If the data shows us anything, it’s that the 5 to 8 unit rowhome is the primary engine of our current success. To cap it now, just as it has begun to outpace single-family home construction, would be to intentionally stall Edmonton's momentum. It would mean fewer homes near transit, higher infrastructure costs for the city, and fewer options for the next generation of Edmontonians.

...
bp_current_ward %>%
  ...
  theme_grey() +
  labs(
    title="Cumulative distribution of 7-8plexes by distance from closest LRT stop in Ward Nakota Isga",
...
bp_current_ward %>%
  ...
  theme_grey() +
  labs(
    title=glue("Cumulative distribution of 7-8plexes by distance from closest LRT stop in Ward {current_ward_name}"),
    subtitle="Existing, under construction, and funded, building permits 2024-2025",
    x="Distance from closest LRT stop (km)",
    y="Cumulative proportion of building permits",
    caption="Jacob Dawang, City of Edmonton Open Data"
